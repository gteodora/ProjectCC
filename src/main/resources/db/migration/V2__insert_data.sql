...
VALUES(NULL, 'admin', 'admin', 'admin@proba', NULL, NULL, NULL);
INSERT INTO `mydb`.`user`(`id`, `username`, `password`, `email`, `name`, `surname`, `create_date`)
VALUES (NULL, 'username1', 'username1', 'username1@proba', NULL, NULL, NULL);
INSERT INTO `mydb`.`user`(`id`, `username`, `password`, `email`, `name`, `surname`, `create_date`)
VALUES (NULL, 'username2', 'username2', 'username2@proba', NULL, NULL, NULL);
